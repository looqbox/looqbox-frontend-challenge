      ...
      <Space orientation="vertical" size={16} style={{ width: '100%' }}>
        <Space orientation="vertical" size={4} style={{ width: '100%' }}>
          ...
          <Paragraph style={{ margin: 0, textAlign: 'center' }} className="section-description">
            Search for Pokémon, explore their types, and dive into their details.
            <br />
            Start here or view the complete Pokédex.
          </Paragraph>
        </Space>
            ...
            <Space className="pokemon-search-buttons">
              ...
              {showSeeAll ? (
                <Link to={`/pokemons?q=${encodeURIComponent(qp.qParam)}&page=1`}>
                  <Button type="primary" className="btn-see-more">
                    See all results ({search.filtered.length})
                  </Button>
                </Link>
              ) : null}
            </Space>
