...
import { PokeBarChart } from "../components/BarChart";
import { PokeChart } from "../components/RadarChart";

const PokemonCard = (props) => {
  const { pokemon, pokemonDescricao, pokemonEntry } = props;
...
const conectado = connect(mapStateToProps)(PokemonCard);

export { conectado as PokemonCard };
