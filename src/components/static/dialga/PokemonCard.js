...
const DialgaCard = (props) => {
  ...
  const pokemon = require("./dialga.json");
  const pokemonDescricao = require("./dialgaDescricao.json");
          ...
          <Container>
            <Row>
              ...
              <Col xs={12} md={8}>
                ...
                <p>
                  It has the power to control time. It appears in Sinnoh-region
...
const conectado = connect(mapStateToProps)(DialgaCard);

export { conectado as DialgaCard };
