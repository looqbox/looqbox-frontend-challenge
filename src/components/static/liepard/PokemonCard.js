...
const LiepardCard = (props) => {
  ...
  const pokemon = require("./liepard.json");
  const pokemonDescricao = require("./liepardDescricao.json");
          ...
          <Container>
            <Row>
              ...
              <Col xs={12} md={8}>
                ...
                <p>
                  These Pokémon vanish and appear unexpectedly. Many Trainers
                  are drawn to their beautiful form and fur.
                </p>
              </Col>
            </Row>
          </Container>
...
const conectado = connect(mapStateToProps)(LiepardCard);

export { conectado as LiepardCard };
