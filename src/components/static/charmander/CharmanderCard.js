...
const CharmanderCard = (props) => {
  ...
  const pokemon = require("./charmander.json");
  const pokemonDescricao = require("./charmanderDescricao.json");
...
const conectado = connect(mapStateToProps)(CharmanderCard);

export { conectado as CharmanderCard };
