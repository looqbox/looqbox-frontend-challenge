...
const VulpixCard = (props) => {
  ...
  const pokemonDescricao = require("./vulpixDescricao.json");
          ...
          <Container>
            <Row>
              ...
              <Col xs={12} md={8}>
                ...
                <p>
                  At the time of birth, it has just one tail.The tail splits
                  from its tip as it grows older.
                </p>
              </Col>
            </Row>
          </Container>
...
const conectado = connect(mapStateToProps)(VulpixCard);

export { conectado as VulpixCard };
